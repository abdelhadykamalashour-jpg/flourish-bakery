        ...
        {submitted ? (
          ...
          >
            <div className="text-center max-w-lg mx-auto px-6">
              ...
              >
                Your order has been received. Our concierge will contact you
                via WhatsApp to coordinate your fresh delivery.
              </motion.p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
              ...
              <div className="lg:col-span-3">
                ...
                >
                  ...
                  <button type="submit" disabled={loading} className="btn-primary mt-8" style={{ opacity: loading ? 0.6 : 1 }}>
                    <span className="btn-text-wrap">
                      <span className="btn-text-default">{loading ? 'Sending…' : `Place Order · EGP ${total.toFixed(0)}`}</span>
                      <span className="btn-text-hover">{loading ? 'Sending…' : `Place Order · EGP ${total.toFixed(0)}`}</span>
                    </span>
                    <span className="btn-circle">
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                        <path d="M2.5 6H9.5M6.5 3L9.5 6L6.5 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
